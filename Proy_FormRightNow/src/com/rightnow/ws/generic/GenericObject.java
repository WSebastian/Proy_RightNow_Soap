            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localIDTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localObjectType.serialize(new javax.xml.namespace.QName("urn:generic.ws.rightnow.com/v1_2","ObjectType"),
                                               factory,xmlWriter);
                                        } if (localGenericFieldsTracker){
                                       if (localGenericFields!=null){
                                            for (int i = 0;i < localGenericFields.length;i++){
                                                if (localGenericFields[i] != null){
                                                 localGenericFields[i].serialize(new javax.xml.namespace.QName("urn:generic.ws.rightnow.com/v1_2","GenericFields"),
                                                           factory,xmlWriter);
                                                } else {
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("urn:generic.ws.rightnow.com/v1_2","GenericObject"));
                 if (localIDTracker){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GenericObject".equals(type)){
                                ...
                                return (GenericObject)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list6 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:generic.ws.rightnow.com/v1_2","ObjectType").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:generic.ws.rightnow.com/v1_2","GenericFields").equals(reader.getName())){
                                    ...
                                    list6.add(com.rightnow.ws.generic.GenericField.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone6){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("urn:generic.ws.rightnow.com/v1_2","GenericFields").equals(reader.getName())){
                                                                    list6.add(com.rightnow.ws.generic.GenericField.Factory.parse(reader));
