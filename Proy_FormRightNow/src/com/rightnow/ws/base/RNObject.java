...
public class RNObject implements org.apache.axis2.databinding.ADBBean
{
	/*
	 * This type was generated from the piece of schema that had name = RNObject
	 * Namespace URI = urn:base.ws.rightnow.com/v1_2 Namespace Prefix = ns1
	 */
		...
		if (serializeType)
		{
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":RNObject", xmlWriter);
			} else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "RNObject", xmlWriter);
			}
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"RNObject".equals(type))
						{
							...
							return (RNObject) com.rightnow.ws.generic.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
