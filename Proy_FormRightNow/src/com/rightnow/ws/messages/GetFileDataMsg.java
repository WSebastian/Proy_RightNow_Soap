                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                           ...
                                           localRNObject.serialize(new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","RNObject"),
                                               factory,xmlWriter);
                                        
                                            if (localFileID==null){
                                                 throw new org.apache.axis2.databinding.ADBException("FileID cannot be null!!");
                                            }
                                           localFileID.serialize(new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","FileID"),
                                               factory,xmlWriter);
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetFileDataMsg".equals(type)){
                                ...
                                return (GetFileDataMsg)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","RNObject").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","FileID").equals(reader.getName())){
