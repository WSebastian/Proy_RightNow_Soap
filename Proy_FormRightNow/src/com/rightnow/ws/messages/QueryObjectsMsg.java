                                       ...
                                       if (localObjectTemplates!=null){
                                            for (int i = 0;i < localObjectTemplates.length;i++){
                                                if (localObjectTemplates[i] != null){
                                                 localObjectTemplates[i].serialize(new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","ObjectTemplates"),
                                                           factory,xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueryObjectsMsg".equals(type)){
                                ...
                                return (QueryObjectsMsg)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","Query").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","ObjectTemplates").equals(reader.getName())){
                                    ...
                                    list2.add(com.rightnow.ws.base.RNObject.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","ObjectTemplates").equals(reader.getName())){
                                                                    list2.add(com.rightnow.ws.base.RNObject.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","PageSize").equals(reader.getName())){
