                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                       ...
                                       if (localRNObjects!=null){
                                            for (int i = 0;i < localRNObjects.length;i++){
                                                if (localRNObjects[i] != null){
                                                 localRNObjects[i].serialize(new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","RNObjects"),
                                                           factory,xmlWriter);
                                                } else {
                                  ...
                                  if (localProcessingOptionsTracker){
                                           ...
                                           localProcessingOptions.serialize(new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","ProcessingOptions"),
                                               factory,xmlWriter);
                                        }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DestroyMsg".equals(type)){
                                ...
                                return (DestroyMsg)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","RNObjects").equals(reader.getName())){
                                    ...
                                    list1.add(com.rightnow.ws.base.RNObject.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","RNObjects").equals(reader.getName())){
                                                                    list1.add(com.rightnow.ws.base.RNObject.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_2","ProcessingOptions").equals(reader.getName())){
