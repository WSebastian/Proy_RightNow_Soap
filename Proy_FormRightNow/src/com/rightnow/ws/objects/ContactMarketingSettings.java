            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localContactListsTracker){
                                    if (localContactLists==null){
                                     ...
                                     localContactLists.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ContactLists"),
                                        factory,xmlWriter);
                                    }
                                    ...
                                    if (localEmailFormat==null){
                                     ...
                                     localEmailFormat.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","EmailFormat"),
                                        factory,xmlWriter);
                                    }
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ContactMarketingSettings".equals(type)){
                                ...
                                return (ContactMarketingSettings)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ContactLists").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","EmailFormat").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","MarketingOptIn").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","MarketingOrganizationName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","MarketingOrganizationNameAlt").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","SurveyOptIn").equals(reader.getName())){
