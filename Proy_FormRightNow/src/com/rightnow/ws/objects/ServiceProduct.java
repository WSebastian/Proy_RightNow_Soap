                ...
                if (localIDTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localCategoryLinks==null){
                                     ...
                                     localCategoryLinks.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","CategoryLinks"),
                                        factory,xmlWriter);
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localDispositionLinks==null){
                                     ...
                                     localDispositionLinks.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","DispositionLinks"),
                                        factory,xmlWriter);
                                    }
                                    ...
                                    if (localEndUserVisibleInterfaces==null){
                                     ...
                                     localEndUserVisibleInterfaces.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","EndUserVisibleInterfaces"),
                                        factory,xmlWriter);
                                    }
                                } if (localNameTracker){
                                    namespace = "urn:objects.ws.rightnow.com/v1_2";
                                    ...
                                    if (localParent==null){
                                     ...
                                     localParent.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","Parent"),
                                        factory,xmlWriter);
                                           ...
                                           localProductHierarchy.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ProductHierarchy"),
                                               factory,xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ServiceProduct"));
                 if (localIDTracker){
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ServiceProduct".equals(type)){
                                ...
                                return (ServiceProduct)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","CategoryLinks").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","DispositionLinks").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","EndUserVisibleInterfaces").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ProductHierarchy").equals(reader.getName())){
