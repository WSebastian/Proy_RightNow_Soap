                ...
                if (localIDTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localIncomingEmailSettings==null){
                                     ...
                                     localIncomingEmailSettings.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","IncomingEmailSettings"),
                                        factory,xmlWriter);
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localOutgoingEmailSettings==null){
                                     ...
                                     localOutgoingEmailSettings.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","OutgoingEmailSettings"),
                                        factory,xmlWriter);
                                    }
                                } if (localTypeTracker){
                                    if (localType==null){
                                     ...
                                     localType.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","Type"),
                                        factory,xmlWriter);
                                    }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","MarketingMailbox"));
                 if (localIDTracker){
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MarketingMailbox".equals(type)){
                                ...
                                return (MarketingMailbox)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","IncomingEmailSettings").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","IsDefault").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","OutgoingEmailSettings").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","Type").equals(reader.getName())){
