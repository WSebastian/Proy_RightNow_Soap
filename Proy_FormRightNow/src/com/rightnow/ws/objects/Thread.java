                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    if (localAccount==null){
                                     ...
                                     localAccount.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","Account"),
                                        factory,xmlWriter);
                                    }
                                    ...
                                    if (localContact==null){
                                     ...
                                     localContact.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","Contact"),
                                        factory,xmlWriter);
                                           ...
                                           localContentType.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ContentType"),
                                               factory,xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localEntryType.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","EntryType"),
                                               factory,xmlWriter);
                                        } if (localIDTracker){
                                            if (localID==null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Thread".equals(type)){
                                ...
                                return (Thread)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribAction!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","Account").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","EntryType").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","MailHeader").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","Text").equals(reader.getName())){
