                           ...
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localStateOrProvince==null){
                                     ...
                                     localStateOrProvince.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","StateOrProvince"),
                                        factory,xmlWriter);
                                    }
                                    ...
                                    if (localValidNullFields==null){
                                     ...
                                     localValidNullFields.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ValidNullFields"),
                                        factory,xmlWriter);
                                           ...
                                           localAddressType.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","AddressType"),
                                               factory,xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","TypedAddress"));
                 if (localCityTracker){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TypedAddress".equals(type)){
                                ...
                                return (TypedAddress)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribAction!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","City").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","PostalCode").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","StateOrProvince").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","Street").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","AddressType").equals(reader.getName())){
