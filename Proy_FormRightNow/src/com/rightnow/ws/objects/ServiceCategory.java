                ...
                if (localIDTracker){
                                    ...
                                    if (localAdminVisibleInterfaces==null){
                                     ...
                                     localAdminVisibleInterfaces.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","AdminVisibleInterfaces"),
                                        factory,xmlWriter);
                                           ...
                                           localCategoryHierarchy.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","CategoryHierarchy"),
                                               factory,xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localProductLinks==null){
                                     ...
                                     localProductLinks.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ProductLinks"),
                                        factory,xmlWriter);
                                    }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ServiceCategory"));
                 if (localIDTracker){
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ServiceCategory".equals(type)){
                                ...
                                return (ServiceCategory)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","CategoryHierarchy").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ProductLinks").equals(reader.getName())){
