                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    if (localContactRole==null){
                                     ...
                                     localContactRole.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ContactRole"),
                                        factory,xmlWriter);
                                    }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","OpportunityContactDelta"));
                 if (localContactTracker){
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"OpportunityContactDelta".equals(type)){
                                ...
                                return (OpportunityContactDelta)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ContactRole").equals(reader.getName())){
