                           ...
                           xmlWriter);
                                    ...
                                    if (localAction != null){
                                     ...
                                     if (localChannelTracker){
                                           ...
                                           localChannelType.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ChannelType"),
                                               factory,xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ChannelUsername".equals(type)){
                                ...
                                return (ChannelUsername)com.rightnow.ws.generic.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribAction!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","ChannelType").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","UserNumber").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_2","Username").equals(reader.getName())){
