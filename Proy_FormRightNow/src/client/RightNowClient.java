...
public class RightNowClient
{
	...
	protected Contact poblarInfoContacto(String _nombre, String _apellido, String _numeroFono, String _numeroMovil, Integer _tipoDocumento, String _numeroDocumento, String _email)
	{
		...
		//Si el numerico telefonico no es nulo se guardara en la lista como parte del dato
		if(_numeroFono != null)
		{
